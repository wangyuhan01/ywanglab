...
<div class="people-section">
  <div class="person">
    <img class="headshot" src="/ywanglab/imgs/Yuhan_Wang.jpg" alt="Yuhan Wang">
  ...
  <div class="person">
    <img class="headshot" src="/ywanglab/imgs/Risa_Mark.png" alt="Risa Y Mark">
    <div class="person-title">Risa Y Mark</div>
    <div class="person-role">Lab Manager</div>
    <div class="person-affiliation">Division of Nutritional Sciences</div>
  </div>
  <div class="person">
    <img class="headshot" src="/ywanglab/imgs/Ziyang_Wang.jpg" alt="Ziyang Wang">
  ...
  <div class="person">
    <img class="headshot" src="/ywanglab/imgs/" alt="Jeslyn Choudhury">
